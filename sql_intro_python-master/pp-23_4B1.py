...
def fill():
    ...
    insert("brian", 24, 2, "marcos")
    insert("leo", 39, 4, "pablo")
    insert("marcelo", 43, 4, "agustin")
    insert("tomas", 24, 1, "brian")
    insert("pablito", 20, 1, "tata")
...
def search_by_grade(grade):
    ...
    values = [grade]
    c.execute("SELECT * FROM estudiante WHERE grade =?", 
              values)
...
def modify(id, name):
    ...
    print("fila actualizada:", rowcount)
